...
?>
<td> <?php echo $pro['couleur']?> </td>
<td> <?php echo $pro['kilometrage']?> </td>
...
<td> 
<form method="GET" action="Modifc.php">
<button type="submit" value="Modifier" name="Modifier"  class="btn btn-primary btn-sm" style="margin-top:3%;margin-left:5%;border-radius: 10%;">Modifier</button>
<input type="hidden" value="<?php echo $pro['id'] ?>" name="id">
</form></td>
</tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../assets7/images/avatar-4.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../assets7/images/avatar-5.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../assets7/images/avatar-3.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
                                                                                    <h6>Ramy Aouinet</h6>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            ...
                                                                            <div class="d-inline-block align-middle">
                                                                                <img src="../assets7/images/avatar-2.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                                                <div class="d-inline-block">
                                            ...
                                            <div class="col-xl-4 col-md-12">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <div class="align-middle m-b-30">
                                                            <img src="../assets7/images/avatar-1.jpg" alt="user image" class="img-radius img-40 align-top m-r-15">
                                                            <div class="d-inline-block">
                                                                <h6>Ramy Mgaidi</h6>
                                                                <p class="text-muted m-b-0">Developer</p>
                                                            </div>
