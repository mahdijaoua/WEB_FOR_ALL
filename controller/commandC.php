    ...
    class commandC{
        ...
        public function g_c_statut($id)
        {
            ...
            try {
                ...
                echo '<label class="badge badge-success"><a href="command.php?status=';echo $id; echo '">Delevred</a></label>';
            }else{
                echo  '<label class="badge badge-warning"><a href="command.php?status=';echo $id; echo '">Not Delevred</a></label>';
            }
        }
